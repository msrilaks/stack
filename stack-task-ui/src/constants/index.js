const dev = {
  ...
  const prod = {
    ACCESS_TOKEN: 'accessToken',
    API_BASE_URL: 'https://www.stackitdown.com:8080',
    GOOGLE_AUTH_URL: 'https://www.stackitdown.com:8080' + '/oauth2/authorize/google?redirect_uri=' + 'http://www.stackitdown.com/oauth2/redirect',
